...
INPUT_PART_FILE=`python random_sample_one_name.py`  #$1
...
nohup python -m sglang.launch_server --model Qwen/Qwen2.5-14B-Instruct --trust-remote-code --port $LLMPORT > $LOG_FILE/LLM.log 2>&1 &
pids[1]=$!
